    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                loading.value = true;
                error.value = '';
                return [4 /*yield*/, authStore.register(form.value.email, form.value.password)];
            case 1:
                result = _a.sent();
                if (result.success) {
                    router.push('/');
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)(__assign({ onSubmit: (__VLS_ctx.handleRegister) }, { class: "bg-white rounded-lg shadow-lg p-8" }));
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)(__assign(__assign({ id: "password", type: "password", required: true, minlength: "6" }, { class: "w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-ukraine-blue focus:border-ukraine-blue" }), { placeholder: "Мінімум 6 символів" }));
(__VLS_ctx.form.password);
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ for: "confirmPassword" }, { class: "block text-sm font-medium text-gray-700 mb-1" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)(__assign(__assign({ id: "confirmPassword", type: "password", required: true }, { class: "w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-ukraine-blue focus:border-ukraine-blue" }), { placeholder: "Повторіть пароль" }));
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input, __VLS_intrinsicElements.input)(__assign({ id: "terms", type: "checkbox", required: true }, { class: "h-4 w-4 text-ukraine-blue focus:ring-ukraine-blue border-gray-300 rounded" }));
(__VLS_ctx.form.acceptTerms);
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ for: "terms" }, { class: "ml-2 block text-sm text-gray-700" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.a, __VLS_intrinsicElements.a)(__assign({ href: "#" }, { class: "text-ukraine-blue hover:text-ukraine-blue-light" }));
if (__VLS_ctx.error) {
...
(__VLS_ctx.loading ? 'Реєструю...' : 'Зареєструватися');
...
// @ts-ignore
var __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0(__assign({ to: "/login" }, { class: "text-ukraine-blue hover:text-ukraine-blue-light font-medium" })));
var __VLS_2 = __VLS_1.apply(void 0, __spreadArray([__assign({ to: "/login" }, { class: "text-ukraine-blue hover:text-ukraine-blue-light font-medium" })], __VLS_functionalComponentArgsRest(__VLS_1), false));
