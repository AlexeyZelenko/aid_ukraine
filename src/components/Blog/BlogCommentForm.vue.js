...
var submitComment = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, push(dbRef(rtdb, "topics/".concat(props.topicId, "/comments")), comment.value)];
            case 1:
                _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.error('Помилка при публікації коментаря:', error_1);
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)(__assign({ onSubmit: (__VLS_ctx.submitComment) }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "mb-4" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ for: "commentContent" }, { class: "block text-gray-700 text-sm font-bold mb-2" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.textarea, __VLS_intrinsicElements.textarea)(__assign(__assign({ id: "commentContent", value: (__VLS_ctx.comment.content) }, { class: "shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-24" }), { placeholder: "Введіть ваш коментар", required: true }));
